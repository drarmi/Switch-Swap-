...
class AdminCoupons {
    ...
    public function __construct() {
        ...
        add_filter( 'woocommerce_rest_pre_insert_shop_coupon_object', [ $this, 'save_rest_coupon_options' ], 10, 1 );
    }
     ...
     */
    public function save_rest_coupon_options( WC_Coupon $coupon ): WC_Coupon {
        $coupon_options = apply_filters( 'dokan_rest_admin_coupon_options_before_save', [
